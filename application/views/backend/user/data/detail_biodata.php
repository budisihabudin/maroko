        ...
        <div class="col-xs-12">
          ...
          <div class="box">
             <div class="box-header"> 
               <a class="btn btn-primary" href="<?php echo base_url('user/lihat_biodata') ?>"><i class="fa fa-sign-out"></i> Kembali</a>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $i; ?></td>
                  <td><img src="<?php echo base_url().'upload/foto/'.$r->foto ?>"></td>
                 ...
                 <td nowrap>
                  ...
                  <a href="<?php echo base_url().'user/hapus_biodata/'.$r->id_anggota; ?>"> <i  class="fa fa-fw fa-trash" title="Hapus"></i></a>  <!-- |  <a href="<?php echo base_url().'admin/detail_pendaftar/'.$a->id?>"> <i  class="fa fa-fw fa-eye" title="Detail"></i></a>  -->
                  </td>
