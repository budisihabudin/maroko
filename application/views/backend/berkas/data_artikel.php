        ...
        <div class="col-xs-12">
          ...
          <div class="box">
             <div class="box-header"> 
              <a class="btn btn-primary" href="<?php echo base_url('admin/tambah_data_artikel'); ?>">Tambah Artikel</a>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <td nowrap>
                  ...
                  <a href="<?php echo base_url().'admin/hapus_data_artikel/'.$r->id_artikel; ?>"> <i  class="fa fa-fw fa-trash" title="Hapus"></i></a>
                  </td>
